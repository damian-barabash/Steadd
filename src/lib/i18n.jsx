...
const DICT = {
  pl: {
    ...
    // page subtitles (friendly one-line explanations)
    "page.sub.dashboard": "Tu widzisz na żywo, co robią dla Ciebie agenci AI — liczby i ostatnie działania.",
    "page.sub.chatbot": "Bot rozmawia z klientami na Twojej stronie i w social mediach. Tu go podłączasz, uczysz i podglądasz rozmowy.",
    "page.sub.leads": "Agent sam znajduje firmy pasujące do Twojego celu i pisze do nich oferty. Ty przejmujesz rozmowę, gdy odpowiedzą.",
    "page.sub.content": "Napisz, o czym ma być treść — AI przygotuje gotowy tekst w tonie Twojej marki. Zwykle zajmuje to około minuty.",
    "page.sub.knowledge": "Im więcej AI wie o Twojej firmie, tym lepsze pisze treści i trafniej odpowiada klientom.",
    "page.sub.settings": "Konto, język panelu oraz adresy i konta, przez które działają agenci.",
    "page.sub.admin": "Klienci, projekty i uprawnienia — wszystko w jednym miejscu.",
    // sidebar / tabs
    ...
    "dash.emptyTitle": "Agenci jeszcze nie działali",
    "dash.emptyText": "Uruchom pierwszego agenta — wygeneruj treść albo załóż kampanię leadową — a tu zobaczysz jego pracę na żywo.",
    // chatbot
    ...
    "bot.emptyConvTitle": "Na razie cisza",
    "bot.emptyConvText": "Gdy ktoś napisze do chatbota na Twojej stronie, rozmowa pojawi się tutaj. Możesz też przetestować bota w zakładce „Kanały”.",
    "bot.emptyArchTitle": "Ustaw, jak bot ma rozmawiać",
    "bot.emptyArchText": "Archetyp to styl rozmowy bota — np. doradca, sprzedawca albo wsparcie. Dodaj pierwszy, aby nadać botowi charakter.",
    "bot.emptyContactsTitle": "Brak kontaktów",
    "bot.emptyContactsText": "Zaimportuj bazę swoich klientów (CSV), aby bot i agenci mieli do niej dostęp.",
    ...
    "leads.emptyCampTitle": "Zacznij od pierwszej kampanii",
    "leads.emptyCampText": "Kampania mówi agentowi, kogo szukać — np. „salony fryzjerskie w Warszawie”. Utwórz ją, a agent zacznie zbierać leady.",
    "leads.emptyLeadsTitle": "Tu pojawią się znalezione firmy",
    "leads.emptyLeadsText": "Uruchom kampanię w zakładce „Kampanie”, a agent znajdzie firmy i doda je do tej listy.",
    // content
    ...
    "img.hint": "Opisz, co ma być na obrazie — AI wygeneruje grafikę do Twoich postów.",
    "img.emptyTitle": "Tu pojawią się wygenerowane obrazy",
    "content.examples": "Przykłady:",
    "content.ex1": "Promocja wiosenna -20%",
    "content.ex2": "Przedstawienie nowej usługi",
    "content.ex3": "Porada ekspercka dla klientów",
    "content.emptyTitle": "Tu pojawią się Twoje treści",
    "content.emptyText": "Wpisz temat po lewej, wybierz format i kliknij „Generuj treść”. Gotowy tekst pojawi się tutaj — zwykle w mniej niż minutę.",
    "content.working": "AI pisze… zwykle zajmuje to mniej niż minutę",
    // knowledge
    ...
    "kb.docsHint": "Dodaj cenniki, opisy usług, FAQ — AI korzysta z nich w rozmowach i treściach.",
    "kb.emptyDocsTitle": "Baza wiedzy jest pusta",
    "kb.emptyDocsText": "Dodaj pierwszy dokument — np. cennik, opis usług albo najczęstsze pytania klientów. AI od razu zacznie z niego korzystać.",
    // settings
  ...
  en: {
    ...
    "page.sub.dashboard": "Watch live what your AI agents are doing for you — the numbers and the latest actions.",
    "page.sub.chatbot": "The bot talks to customers on your website and social media. Connect it, teach it and review conversations here.",
    "page.sub.leads": "The agent finds companies matching your goal and writes them offers. You take over once they reply.",
    "page.sub.content": "Describe what the content should be about — the AI writes a ready text in your brand voice. Usually takes about a minute.",
    "page.sub.knowledge": "The more the AI knows about your business, the better its content and answers.",
    "page.sub.settings": "Your account, panel language, and the addresses and accounts your agents act through.",
    "page.sub.admin": "Clients, projects and permissions — all in one place.",
    ...
    "dash.emptyTitle": "Your agents haven't worked yet",
    "dash.emptyText": "Start your first agent — generate a piece of content or create a lead campaign — and you'll see its work here live.",
    ...
    "bot.emptyConvTitle": "All quiet for now",
    "bot.emptyConvText": "When someone writes to the chatbot on your website, the conversation appears here. You can also test the bot in the \"Channels\" tab.",
    "bot.emptyArchTitle": "Choose how the bot should talk",
    "bot.emptyArchText": "An archetype is the bot's conversation style — e.g. advisor, salesperson or support. Add the first one to give the bot a character.",
    "bot.emptyContactsTitle": "No contacts yet",
    "bot.emptyContactsText": "Import your customer base (CSV) so the bot and agents can use it.",
    ...
    "leads.emptyCampTitle": "Start with your first campaign",
    "leads.emptyCampText": "A campaign tells the agent who to look for — e.g. \"hair salons in Warsaw\". Create one and the agent starts collecting leads.",
    "leads.emptyLeadsTitle": "Found companies will appear here",
    "leads.emptyLeadsText": "Run a campaign in the \"Campaigns\" tab and the agent will find companies and add them to this list.",
    ...
    "img.hint": "Describe what the image should show — the AI generates a graphic for your posts.",
    "img.emptyTitle": "Generated images will appear here",
    "content.examples": "Examples:",
    "content.ex1": "Spring promo -20%",
    "content.ex2": "Introducing a new service",
    "content.ex3": "Expert tip for customers",
    "content.emptyTitle": "Your content will appear here",
    "content.emptyText": "Enter a topic on the left, pick a format and click \"Generate content\". The ready text shows up here — usually in under a minute.",
    "content.working": "The AI is writing… usually takes under a minute",
    ...
    "kb.docsHint": "Add price lists, service descriptions, FAQs — the AI uses them in conversations and content.",
    "kb.emptyDocsTitle": "The knowledge base is empty",
    "kb.emptyDocsText": "Add the first document — e.g. a price list, service description or common customer questions. The AI starts using it right away.",
