...
const DICT = {
  pl: {
    ...
    "tab.admin": "Administracja", "tab.analytics": "Analityka", "inq.title": "Zgłoszenia",
    // analytics
    "an.title": "Analityka strony", "an.subtitle": "Ruch na stronie steadd.pl",
    "an.visits": "Wizyty", "an.pageviews": "Odsłony", "an.avgTime": "Śr. czas na stronie",
    "an.bounce": "Współczynnik odrzuceń", "an.activeToday": "Aktywni dziś",
    "an.daily": "Wizyty i odsłony dziennie", "an.topPages": "Najczęstsze strony",
    "an.referrers": "Źródła ruchu", "an.devices": "Urządzenia", "an.langs": "Języki",
    "an.direct": "Wejścia bezpośrednie", "an.mobile": "Mobile", "an.desktop": "Desktop",
    "an.period7": "7 dni", "an.period30": "30 dni", "an.period90": "90 dni",
    "an.noData": "Brak danych w tym okresie. Dane pojawią się, gdy ktoś odwiedzi stronę.",
    "an.visitsShort": "wizyt", "an.viewsShort": "odsłon", "an.err": "Nie udało się wczytać danych.",
    // project switcher
  ...
  en: {
    ...
    "tab.admin": "Administration", "tab.analytics": "Analytics", "inq.title": "Inquiries",
    "an.title": "Site analytics", "an.subtitle": "Traffic on steadd.pl",
    "an.visits": "Visits", "an.pageviews": "Page views", "an.avgTime": "Avg. time on site",
    "an.bounce": "Bounce rate", "an.activeToday": "Active today",
    "an.daily": "Daily visits & page views", "an.topPages": "Top pages",
    "an.referrers": "Traffic sources", "an.devices": "Devices", "an.langs": "Languages",
    "an.direct": "Direct", "an.mobile": "Mobile", "an.desktop": "Desktop",
    "an.period7": "7 days", "an.period30": "30 days", "an.period90": "90 days",
    "an.noData": "No data for this period yet. It appears once people visit the site.",
    "an.visitsShort": "visits", "an.viewsShort": "views", "an.err": "Failed to load data.",
